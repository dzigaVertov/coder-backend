...
** Entregable 23-05
*** TODO Terminar validaciones productos
*** TODO Modificar controladores productos
** Entregable 06-06
*** TODO Crear modelos
**** DONE Crear Factory
**** TODO Crear modelo usuarios
**** TODO Agregar rol
**** TODO Agregar validación usuario
**** TODO Cambiar schema usuario a carpeta DAO
**** TODO Hacer que el repositorio de usuario trabaje con el modelo de usuario
**** TODO Agregar middleware de rol
**** TODO Restringir acceso a rutas según rol
*** TODO Crear modelo Ticket
*** TODO Agregar validaciones a modelos
