...
**** TODO Generar cart de usuario al registrar
...
** Nuevo entregable
*** TODO Hacer estrategia de rol
*** TODO restringir vista carrito a usuario logueado
*** TODO Restringir agregado de productos a admin
* Notas
