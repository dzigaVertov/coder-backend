...
***** TODO No se puede ir a login si ya está logeado

***** TODO Agregar botón de deslogueo

**** DONE Implementar el método de autenticación de GitHub a la vista de login.
